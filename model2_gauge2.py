...
def level_gauge2 (img_path, mtrx):
    ...
    if final_bbox:
        ...
        if mask_crop == None:
            ...
            new_mask = np.zeros((h2, w2))

            contours, hierachy = cv2.findContours(img_new, cv2.RETR_CCOMP, cv2.CHAIN_APPROX_NONE)
            ...
            if mtrx.size == 0:
                ...
                result = cv2.warpPerspective(new_mask, mtrx, (2000, 3000))

                '9. distance'    
                level = level_est(result)
    else:
        level = -999
...
# cv2.imwrite('test.jpg', plate1)    
# 
# level_gauge2 (img_path, mtrx)
# =============================================================================
